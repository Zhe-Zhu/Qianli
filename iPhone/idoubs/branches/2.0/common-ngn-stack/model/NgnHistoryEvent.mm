...
//LG
+(NgnHistoryImageEvent*) createImageEventWithStatus: (HistoryEventStatus_t) _status andRemoteParty:(NSString*)_remoteParty{
	return [NgnHistoryEvent createImageEventWithStatus:_status andRemoteParty:_remoteParty andContent:nil];
}

+(NgnHistoryImageEvent*) createImageEventWithStatus: (HistoryEventStatus_t) _status andRemoteParty:(NSString*)_remoteParty andContent: (NSData*)_contentArg{
	NgnHistoryImageEvent* event = [[[NgnHistoryImageEvent alloc] initWithStatus:_status andRemoteParty:_remoteParty andContent:_contentArg] autorelease];
	return event;
}
